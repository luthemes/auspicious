...
add_action( 'after_setup_theme', function() {
		...
		/**
		 * By add_image_size( 'auspicious-small-thumbnails', 324, 324, true );. This should be used for content in the home for blogs.
		 */
		add_image_size( 'auspicious-small-thumbnails', 324, 324, true );

		/**
		 * By add_image_size( 'auspicious-medium-thumbnails', 810, 396, true );. This should be used for content that has sidebars.
		 */
		add_image_size( 'auspicious-medium-thumbnails', 810, 396, true );

		/**
		 * By add_image_size( 'auspicious-large-thumbnails', 1170, 614, true );. This should be used for content that has no sidebars.
		 */
		add_image_size( 'auspicious-large-thumbnails', 1170, 614, true );
		 ...
		 */
		load_theme_textdomain( 'auspicious', get_parent_theme_file_path( '/languages ' ) );
	}
);
...
add_action( 'backdrop/templates/register', function( $templates ) {
	$templates->add( 'template-left-sidebar.php', [
		'label' => esc_html__( 'Left Sidebar', 'auspicious' )
	] );

	$templates->add( 'template-right-sidebar.php', [
		'label' => esc_html__( 'Right Sidebar', 'auspicious' )
	] );
} );